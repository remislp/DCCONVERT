""" 
    Convert SCAN generated file (containing time intervals, amplitudes and
    flags) into a text file with three tab-separated columns.
    ...
    tres: number- temporal resolution in microseconds (eg 20) 
